...
r1 = readh5file('cde_50x5x100.h5', 50, 5)
r2 = readh5file('cde_200x5x400.h5', 200, 5)
r3 = readh5file('cde_2000x5x4000.h5', 2000, 5)
...
for t in r3['t']:
  ct = Ogata_Banks(2.5, t, 1.0, 0.01)
  c1.append(ct)
  ct = Ogata_Banks(5.0, t, 1.0, 0.01)
  c2.append(ct)
...
lgd = plt.legend(('Pe = 10', 'Pe = 2.5', 'Pe = 0.25', 'Analytical'),loc=4)
