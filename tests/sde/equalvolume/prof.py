...
r1 = readh5file('sde_5x10x200.h5', 5, 10)
r2 = readh5file('sde_5x20x200.h5', 5, 20)
r3 = readh5file('sde_5x50x200.h5', 5, 50)
cin = 1.0 #1.9941e-07;
nr = 100
...
lgd = plt.legend(('nr = 10', 'nr = 20', 'nr = 50', 'Analytical'),loc=3)
