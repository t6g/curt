...
r1 = readh5file('sde_5_100.h5', 5, 100)
r2 = readh5file('sde_5_200.h5', 5, 200)
r3 = readh5file('sde_5_500.h5', 5, 500)
r4 = readh5file('sde_5_1000.h5', 5, 1000)
cin = 1.0 #1.9941e-07;
nr = 100
...
nr = 1000
c4 = np.asarray(r4['c'][:, i].reshape(nr+1, nx))[1:nr+1, 0]

plt.plot(r1['r'], c1, 'b-', r2['r'], c2, 'r-', r3['r'], c3, 'g-', r4['r'], c4, 'm-')
plt.ylabel('c/c$_0$')
plt.xlim([0, xmax])
plt.ylim([0, 1.2])
...
nr = 1000
c4 = np.asarray(r4['c'][:, i].reshape(nr+1, nx))[1:nr+1, 0]
plt.plot(r1['r'], c1, 'b-o', r2['r'], c2, 'r-x', r3['r'], c3, 'g-+', r4['r'], c4, 'm-')
plt.xlim([0, xmax])
plt.ylim([0, 1.2])
plt.text(lx, ly, '(d) t = %d s' % (r1['t'][i]), transform=ax4.transAxes)
plt.xlabel('r (mm)')
plt.setp(ax4.get_yticklabels(), visible=False)
lgd = plt.legend(('nr = 100', 'nr = 200', 'nr = 500', 'nr = 1000'),loc=1)
